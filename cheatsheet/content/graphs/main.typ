...
Bipartite Graph is a special graph with the following characteristics: the set of vertices V can be partitioned into two disjoint sets V1 and V2 and all undirected edges (u, v) $in E$ have the property that u $in V_1$ and v $in V_2$. This makes a Bipartite Graph free from odd-length cycle.
...
- The flow of an edge cannot exceed the capacity $f(e) <= c(e)$
...
#include "maximum_flow.typ"

#include "cutpoints.typ"

#include "cayley_formula.typ"

#include "burnside_lemma.typ"
